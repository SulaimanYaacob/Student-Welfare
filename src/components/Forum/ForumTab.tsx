    ...
    <Grid grow>
      ...
      <Grid.Col span="auto">
        ...
        <Stack sx={() => ({ height: 300 })} mx={"xl"}>
          ...
          <Text ta="center">PERSONAL NAVIGATOR</Text>
          <Button variant="subtle">My Questions</Button>
          <Button variant="subtle">My Answers</Button>
          <Button variant="subtle">My Likes</Button>
        </Stack>
      </Grid.Col>
    </Grid>
  );

import { Image, Paper, Text, Avatar, Stack, ScrollArea, Group, Table, Button, ActionIcon, Modal, TextInput, Grid } from "@mantine/core";
    ...
    return (
      <>
        ...
        <Stack spacing="xs">
                ...
                <Stack ml={20} spacing="md">
                    <Group position="apart" spacing={0}>
                        <Group spacing={0}>
                            ...
                            />
                            <ActionIcon size="lg" mt={40} ml={-50} color="cyan" radius="xl" variant="filled">
                                <FaPen style={{ color: "white" }}/>
                            </ActionIcon>
                        </Group>
                        <Stack mr="xl" mt={20}>
                            <Button onClick={() => setOpened(true)} variant="outline" color="dark" leftIcon={<FaPen/>}>Edit Profile</Button>
                    ...
                    <Stack ml={10} mt={-20} spacing="md" align="flex-start">
                        ...
                        <Stack spacing={5}>
                            <Text fz={15} fw={530}>Bio</Text>
                            <Text fz={15}>My name is David Addams. I am a money collector and a trusted MLM agent.</Text>
                        </Stack>
                        <Group spacing="xl">
            ...
            <Paper bg="#FFF" mx="auto" mt="xs" mb="xs" py="xl" pl={10} radius="md" pb="xl" style={{ width: 1000 }}>
                <Stack ml={20}>
                    <Text  fz={20} fw="bold">About Me</Text>
                    <Table ml={0}>
                        <tbody>
                            <tr>
                                <td style={{ width: 200 }}><Text fz={15} fw={550}>Residential College</Text></td>
                    ...
                    <Table ml={0}>
                        <tbody>
                            <tr>
                                <td style={{ width: 200 }}><Text fz={15} fw={550}>Faculty</Text></td>
                    ...
                    <Table ml={0}>
                        <tbody>
                            <tr>
                                <td style={{ width: 200 }}><Text fz={15} fw={550}>Year / Course</Text></td>
                                <td><Text fz={15}>3 / SECJH</Text></td>
                            </tr>
                        </tbody>
                    </Table>
                    <Table ml={0}>
                        <tbody>
                            <tr>
                                <td style={{ width: 200 }}><Text fz={15} fw={550}>Hometown</Text></td>
                                <td><Text fz={15}>Idaho, United States of America</Text></td>
                            </tr>
                        </tbody>
                    </Table>
                </Stack>
            </Paper>
            <Paper bg="#FFF" mx="auto" mt="xs" mb={30} py="xl" pl={10} radius="md" pb="xl" style={{ width: 1000 }}>
                <Stack ml={20}>
                    <Text fz={20} fw="bold" mb={10}>Social</Text>
                    <Stack ml={10}>
                        <Group spacing="xl">
                            <BsFillTelephoneFill style={{ color:"#5CBC55" }} size={18}/>
                            <Text fz={15} fw={550}> +(60)13-2345457</Text>
                        </Group>
                        <Group spacing="xl">
                            <FiMail style={{ color:"#E03131" }} size={18}/>
                            <Text fz={15} fw={550}> davidaddams01@gmail.com</Text>
                        </Group>
                        <Group spacing="xl">
                            <SiInstagram style={{ color:"#D6336C" }} size={18}/>
                            <Text fz={15} fw={550}> @d_addams01</Text>
                        </Group>
                        <Group spacing="xl">
